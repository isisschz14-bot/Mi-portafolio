...
Limpieza, procesamiento y visualización de datos

Generación de insights para la toma de decisiones

📁 Contenido del repositorio
1. Evaluative Assignment – Task 1

Notebook: Copia_de_Evaluative_Assignment_TASK1_Isis.ipynb
...
2. Evaluative Assignment – Task 2

Notebook: TASK_2_Isis.ipynb
...
Conclusiones de la segunda parte del ejercicio

(Conforme agregue más notebooks, este índice crecerá.)
...
Este repositorio tiene el objetivo de documentar mi avance profesional en análisis de datos, así como mostrar proyectos aplicados a economía y ciencias sociales. Planeo mantener una estructura clara y cada proyecto incluirá:
